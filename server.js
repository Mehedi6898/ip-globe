...
const MESSAGE_LINES = {
  sc_A: [
    ...
    "Your countries web blocker is blocking connection to hacks servers.",
    "Hack may show wrong because of the block.",
    "This problem can be easily fixed by using Antidetect.",
    "It's an extension like the hack youre using that hides and protect you from detection by your countries web blocking and run Hack smoothly.",
  ...
  "1_": [
    ...
    "Main Server status - ok",
    "Client side status - unable to receive!",
    "Your countries web blocker is blocking connection to Predictor servers.",
    "App may show wrong predictions or app may showing numbers fast.",
    "This problem can be easily fixed by using Antidetect.",
    "It's a software that hides and protect you from detection by your countries web blocking and run predictor smoothly.",
    "Buy AntiDetect to establish connection",
    "Get here➡️ antidetect.fun",
  ],
  sc_M: [
